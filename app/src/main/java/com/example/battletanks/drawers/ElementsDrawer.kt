...
class ElementsDrawer (val container: FrameLayout){
    ...
    fun move(myTank: View,direction: Direction){
        ...
        if(checkTankCanMoveThroughBorder(
                nextCoordinate, myTank) && checkTankCanMoveThroughMaterial(nextCoordinate)
        ){
    ...
    // Метод, который не дает танку выйти за границы поля
    ...
    // Метод, который возвращает нам координаты всех четырех углов нашего танка
